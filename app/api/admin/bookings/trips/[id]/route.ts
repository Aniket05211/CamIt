...
export async function PATCH(
  ...
  try {
    ...
    console.log("Updating trip booking with ID:", id)
    ...
    if (error) {
      ...
      return NextResponse.json(
        { 
          success: false, 
          error: "Failed to update trip booking",
    ...
    console.log("Successfully updated trip booking:", updatedBooking)
    ...
    console.error("Error in trip booking update API:", error)
    return NextResponse.json(
      { 
        success: false, 
