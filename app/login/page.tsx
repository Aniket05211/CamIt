...
export default function Login() {
  ...
  // Check for URL parameters (Google auth errors and success)
  useEffect(() => {
    console.log("=== LOGIN PAGE URL PARAMS DEBUG ===")
    ...
    if (message) {
      console.log("Showing success toast:", decodeURIComponent(message))
      toast({
        title: "Success",
    ...
    // Handle Google auth user data (same as email/password login)
    if (userParam && message?.includes("Google authentication successful")) {
      try {
        ...
        // Redirect to home page (same as email/password login)
